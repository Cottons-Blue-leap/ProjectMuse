...
### 제목 (Title)
```
ジョプリン - ジ・エンターテイナー (feat. 初音ミク)
```

### 설명 (Description)
```
誰もが知る旋律が名曲になりました。
9人のミクが歌います。スコット・ジョプリン - ジ・エンターテイナー（1902）

カバーアート：グラッケンズの絵画「ハマースタインのルーフガーデン」（1901）をもとに。
...
### 제목 (Title)
```
조플린 - 디 엔터테이너 (feat. 初音ミク)
```

### 설명 (Description)
```
익숙한 멜로디가 클래식이 되는 법.
아홉 명의 미쿠가 노래하는 스콧 조플린 - 디 엔터테이너 (1902)

커버 모티브 아트: 글래컨스의 '해머스타인의 루프 가든' (1901)
https://commons.wikimedia.org/wiki/File:Hammerstein%27s_Roof_Garden,_by_William_Glackens.jpg
